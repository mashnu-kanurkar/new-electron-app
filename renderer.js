...
ipcRenderer.on(NOTIFICATION_RECEIVED, (_, serverNotificationPayload) => {
  ...
  console.log("serverNotificationPayload",serverNotificationPayload)
  console.log("text",serverNotificationPayload.data.text())
...
// Start service
const senderId = '927930704584' // <-- replace with FCM sender ID from FCM web admin under Settings->Cloud Messaging
